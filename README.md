...
> **Dashboard & newsletter endpoints** — `/admin/analytics/*`, `/admin/newsletter/*`,
> and the public `/newsletter/*` routes are documented in full in
> [DASHBOARD_API.md](./DASHBOARD_API.md). They require migration `0005`
> (`npm run db:migrate`).
